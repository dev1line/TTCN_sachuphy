...
const data = [
    {
      key: 1,
      image: "https://fptshop.com.vn/Uploads/Originals/2020/6/2/637266923420476975_hp-15s-fq-bac-1.png" ,
      name: 'John Brown',
      price: 32,
      sl: 1,
      all: 32,
...
const FormInfo = (props) => {
    ...
    return (
        <Row>
            <Col span={24}>
                <Form {...layout} name="nest-messages" onFinish={onFinish} className="abc-form">
                    ...
                    <Button className="checkout" size="large" type="primary" htmlType="submit">
                        Đặt Hàng
                    </Button>
