<template>
  <div>
    ...
    <div class="content">
      <!-- Header Loader -->
      <base-block title="Header Loader" content-full>
        ...
        <b-table-simple responsive striped table-class="table-vcenter mb-0">
          ...
          <b-tbody>
            <b-tr>
              <b-td>
                <base-layout-modifier variant="primary" action="headerLoaderOn" size="sm">Start Header Loader</base-layout-modifier>
              </b-td>
              <b-td>
            ...
            <b-tr>
              <b-td>
                <base-layout-modifier variant="primary" action="headerLoaderOff" size="sm">Stop Header Loader</base-layout-modifier>
              </b-td>
              <b-td>
      ...
      <!-- Page Loader -->
      <base-block title="Page Loader" content-full>
        <p class="font-size-sm text-muted">
        ...
        <b-button size="sm" variant="primary" class="mb-3" @click="pageLoaderPreview">Preview Page Loader</b-button>
        <b-table-simple responsive striped table-class="table-vcenter mb-0">
          <b-thead>
            <b-tr>
